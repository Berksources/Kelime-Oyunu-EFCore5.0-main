...
namespace DataAccesLayer
{
    public interface IRepository
    {
        ...
        {
            protected KelimeOyunuDBContext _context;
            private readonly DbSet<T> _dbSet;
            public Repository(KelimeOyunuDBContext context)
            {
            ...
            public KelimeOyunuDBContext KelimeOyunuDBContext { get { return _context as KelimeOyunuDBContext; } }
        }
